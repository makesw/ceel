...
FROM cursos c JOIN usuarios u ON c.id_creador = u.id AND c.fecha_finalizacion > NOW() AND u.id =' . $_SESSION[ 'dataSession' ][ 'id' ] );
			...
			<aside class="col-xs-12 col-sm-3 col-md-3 profile">
				...
				<div class="form-profile">					
						...
						<div class="form-group logout-profile" id="div-editprof">
							<span onclick="profileEdit();" style="cursor: pointer;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Editar Perfil</span>
						</div>
			...
			<div class="col-xs-12 col-sm-9 col-md-9">
				<div class="row p-texts">
					...
					<div class="col-xs-10 col-sm-11 col-md-11">
						<h3 class="title-p">Cursos Publicados</h3>
						<span class="text-p">Estos son los cursos que haz publicado: <a href="#"><?php echo($_SESSION['dataSession']['nombres'].' '.$_SESSION['dataSession']['apellidos']); ?></a></span>
					</div>
				</div>
