	...
	<div class="container-fluid">
		...
		<div class="row p-texts">
			...
			<div class="col-xs-10 col-sm-7 col-md-8">
				<h3 class="title-p">Editar Lección:</h3>
			</div>
			...
			<div class="col-md-12">
				...
				<div class="col-sm-8 col-md-8 add-unity">
					...
					<div class="form-group input-add-course col-md-12">
						...
						<div class="col-md-8">
							<input class="form-control" type="text" placeholder="Ingrese el nombre de la lección" id="nombre" name="nombre" value="<?php echo $lesson['nombre'];?>" >
						</div>
					</div>
					<div class="form-group input-add-course col-md-12">
						<div class="col-md-4">
						...
						<div class="col-md-8">
							<input class="form-control" type="text" placeholder="Ingrese el subtitulo de la lección" id="subtitulo" name="subtitulo" value="<?php echo $lesson['subtitulo'];?>" >
						</div>
					</div>
					<div class="form-group input-add-course col-md-12">
						<div class="col-md-4">
						...
						<div class="col-md-8">
							<textarea class="form-control" rows="3" placeholder="Ingrese la descripción de la lección" id="descripcion" name="descripcion" ><?php echo $lesson['descripcion'];?></textarea>
						</div>
					</div>
					<div class="form-group input-add-course col-md-12">
						<div class="col-md-4">
						...
						<div class="col-md-8">
							...
							<input type="hidden" name="numeroL" id="numerol" value="<?php echo $lesson['numero'];?>">
		...
		<div class="col-md-12 btn-add">				
			...
			<div id="div-msg-fail"  hidden="true"  class="alert msg-ceel-fail" role="alert">
				...
				<i id="div-msg-fail-desc">Ocurrió un error actualizando la Lección</i>
			</div>
		</div>
		</form>
                          ...
                          {  							  
							  echo '  
                               <tr> 
                                    ...
                                    <td>'.$row["enunciado"].'</td>
									<td class="last-info-edit">										
									<a href="javascript:fn_edit_question('.$row["id"].','.$lesson_id.','.$course_id.','.$unity_id.');">Detalle</a> | <input type="checkbox" value="'.$row["id"].'">
									</td>
                               </tr>  
                               ';
							  $iter++;
...
<script>
var arrIds=[];
$('#tbl_questions tbody').on('change', 'input[type="checkbox"]', function(){
	if($(this).is(':checked')){
	...
	if(arrIds.length<1){
		...
		$.ajax({
			...
			success: function (data) {
				if(!data.deleteAll){
					$('#div-msg-fail-desc').text( "No todas las preguntas se eliminaron." );
					$('#div-msg-fail').show();
					setTimeout(function(){
						location.reload();
					},2000);
					...
					console.log(data);
					$('#div-msg-ok-desc').text( "Preguntas eliminadas con éxito." );
					$('#div-msg-ok').show();
					setTimeout(function(){
						location.reload();
					},2000);
