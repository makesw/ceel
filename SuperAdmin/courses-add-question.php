		...
		<div class="row header-bread">
			...
			<div class="col-xs-6 col-sm-6 col-md-8">
				<ol class="breadcrumb">
					...
					<li class="active">Crear Pregunta
					</li>
				</ol>
			</div>
			...
			<div class="col-md-12">
				...
				<div class="col-sm-8 col-md-8 add-unity">
					...
					<div class="form-group input-add-course col-md-12" id="divNumResp">
						...
						<select class="form-control" required id="numResp" name="numResp">
							<option value="">Seleccione</option>
...
<script>
	...
	jQuery(document).on('submit','#form-create-question', function(event){
		if( $('#tipoPregunta').val()==2 && !$('input[name="checkbox[]"]:checked').length > 0 ){
			alert('Selecione almenos una respuesta!');
			event.preventDefault();	
		}else{
			$.ajax({
				url: 'actions.php?action=createQuestion',
				type: 'POST',
