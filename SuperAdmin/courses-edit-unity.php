	...
	<div class="container-fluid">
		...
		<div class="row p-texts">
			...
			<div class="col-xs-10 col-sm-7 col-md-8">
				<h3 class="title-p">Editar Unidad de Curso</h3>
				<span class="text-p">Aquí puedes editar las unidades del curso:</span>
			</div>
		...
		<form class="form-horizontal form-add-course" id="form-edit-unity" method="post">
				...
				<div class="col-md-12">
					...
					<div class="col-sm-8 col-md-8 add-unity">
						...
						<div class="form-group input-add-course">
							...
							<div class="col-md-8">
								<input class="form-control" type="text" placeholder="Ingrese el nombre de la unidad" id="nombre" name="nombre" required value="<?php echo $unity['nombre'];?>">
							</div>
						</div>
						<div class="form-group input-add-course">
							<div class="col-md-4">
							...
							<div class="col-md-8">
								<input class="form-control" type="text" placeholder="Ingrese el subtitulo de la unidad" id="subtitulo" name="subtitulo" required value="<?php echo $unity['subtitulo'];?>">
							</div>
						</div>
						<div class="form-group input-add-course">
							<div class="col-md-4">
							...
							<div class="col-md-8">
								<textarea class="form-control" rows="4" placeholder="Ingrese la descripción de la unidad" id="descripcion" name="descripcion" required><?php echo $unity['descripcion'];?></textarea>
							</div>
						</div>
						<div class="form-group input-add-course">
							<div class="col-md-4">
						...
						<div class="form-group input-add-course">
							...
							<div class="col-md-8 check-unity">
						   	 ...
						   	 <input type="checkbox" id="evaluar" name="evaluar" <?php echo $unity['requiere_evaluar']?'checked':'';?>>Evaluar unidad
						    </label>							
								<label class="checkbox-inline">
						      <input type="checkbox" id="requerida" name="requerida" <?php echo $unity['requerida']?'checked':'';?>> Requerido
						    </label>							
							</div>
						</div>
						<hr>
			...
			<div class="col-md-12 btn-add">				
			  ...
			  <strong>Hecho!</strong> <i id="div-msg-ok-desc">Unidad Actualizada con Éxito</i>
			</div>
			<div id="div-msg-fail"  hidden="true"  class="alert msg-ceel-fail" role="alert">
				...
				<i id="div-msg-fail-desc">Ocorrió un error actualizando la Unidad</i>
			</div>
			</div>
		</form>
		...
		<div class="row edit-courses">				
				...
				<form id="form-remove-lesson" method="post" name="form-remove-lesson">
					<table class="table table-responsive" id="tbl_lessons">
						<tr>
...
<script>
var arrIds=[];
$('#tbl_lessons tbody').on('change', 'input[type="checkbox"]', function(){
	if($(this).is(':checked')){
	...
	if(arrIds.length<1){
		...
		$.ajax({
			...
			success: function (data) {
				if(!data.deleteAll){
					$('#div-msg-fail-desc').text( "No todas las lecciones se eliminaron." );
					$('#div-msg-fail').show();
					setTimeout(function(){
						location.reload();
					},2000);
					...
					console.log(data);
					$('#div-msg-ok-desc').text( "Lecciones eliminadas con éxito." );
					$('#div-msg-ok').show();
					setTimeout(function(){
						location.reload();
					},2000);
